...
def get_shandi_labels():
    return np.asarray([
        [100, 150, 200],  # label 0 的色彩      # blue ---山地
        [0, 0, 0],  # label 1 的色彩      # black ---非山地
    ])

# ===========================================================================================================
# 评价指标

def cal_hist(a, b, n):  # y_pred, y, self.num_class
    k = (a >= 0) & (a < n)
...
def read_img_information(index):
    ...
    if index == 1:
        ...
        img_name = 'c_missp'
        target_names = ['water','framland', 'buildings', 'tree','others',]
        aim = 4
        img_num = 889
        ...
        single_size = (512, 512, 3)
        gt_shape = (28692, 30816)
        img_name = 'shate'
        target_names = ['tree', 'others']
        aim = 0
        img_num = 3359
    elif index == 'shandi_tongchuan_-2':
        single_size = [512, 512, 3]
        gt_shape = (12465, 14096, 3)
        img_name = 'shandi_tongchuan_-2'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 648
    elif index == 'shandi_xianyang_3':
        single_size = [512, 512, 3]
        gt_shape = (9601, 9280, 3)
        img_name = 'shandi_xianyang_3'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 324
    elif index == 'shandi_xian_3':
        single_size = [512, 512, 3]
        gt_shape = (11969, 13761, 3)
        img_name = 'shandi_xian_3'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 598
    elif index == 'shandi_yanta':
        single_size = [512, 512, 3]
        gt_shape = (12496, 14417, 3)
        img_name = 'shandi_yanta'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 672
    elif index == 'shandi_yanan_1':
        single_size = [512, 512, 3]
        gt_shape = (12288, 12065, 3)
        img_name = 'shandi_yanan_1'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 552
    elif index == 'shandi_yanan_2':
        single_size = [512, 512, 3]
        gt_shape = (10225, 10601, 3)
        img_name = 'shandi_yanan_2'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 380
    elif index == 'shandi_shangluo_2':
        single_size = [512, 512, 3]
        gt_shape = (11121, 11409, 3)
        img_name = 'shandi_shangluo_2'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 462
    elif index == 'shandi_shangluo_3':
        single_size = [512, 512, 3]
        gt_shape = (12337, 12352, 3)
        img_name = 'shandi_shangluo_3'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 576
    elif index == 'shandi_shangluo_4':
        single_size = [512, 512, 3]
        gt_shape = (11536, 11713, 3)
        img_name = 'shandi_shangluo_4'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 484
    elif index == 'shandi_ankang_4':
        single_size = [512, 512, 3]
        gt_shape = (9026, 10409, 3)
        img_name = 'shandi_ankang_4'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 340
    elif index == 'shandi_baoji_1':
        single_size = [512, 512, 3]
        gt_shape = (11585, 11664, 3)
        img_name = 'shandi_baoji_1'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 484
    elif index == 'shandi_hanzhong_1':
        single_size = [512, 512, 3]
        gt_shape = (9856, 11680, 3)
        img_name = 'shandi_hanzhong_1'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 418
    elif index == 'shandi_yulin_1':
        single_size = [512, 512, 3]
        gt_shape = (11872, 12273, 3)
        img_name = 'shandi_yulin_1'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 529
    elif index == 'shandi_zhouzhi_4':
        single_size = [512, 512, 3]
        gt_shape = (13825, 15345, 3)
        img_name = 'shandi_zhouzhi_4'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 783
    elif index == 'shandi_xian_11':
        single_size = [512, 512, 3]
        gt_shape = (10193, 11744, 3)
        img_name = 'shandi_xian_11'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 418
    elif index == 'shandi_yulin_3':
        single_size = [512, 512, 3]
        gt_shape = (9896, 10928, 3)
        img_name = 'shandi_yulin_3'
        target_names = ['mountain', 'not mountain']
        aim = 2
        img_num = 399
